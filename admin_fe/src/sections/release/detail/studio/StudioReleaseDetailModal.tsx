...
import { AddCircleOutline, CheckCircleOutlined, CloseOutlined, CloseRounded, DragIndicator, EditOutlined, ErrorOutline, FormatListBulletedOutlined, PublishOutlined, SaveOutlined, WarningOutlined } from "@mui/icons-material";
    ...
    return (
        <div className="fixed inset-0 z-100 flex items-center justify-center bg-base/70 backdrop-blur-sm p-4">
            <div className="relative w-full max-w-4xl mx-auto">
                ...
                {isLoading ? <ReleaseDetailSkeleton />
                :
                    <div className="bg-panel w-full h-[90vh] flex flex-col rounded-3xl border border-border shadow-2xl relative animate-fadeIn overflow-hidden">
                        {/* Header */}
                        <ModalHeader 
                            isArtist={true} 
                            release={release}
