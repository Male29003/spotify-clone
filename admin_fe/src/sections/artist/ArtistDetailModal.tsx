                ...
                <div className="relative p-6 pt-10 border-b border-border flex flex-wrap justify-between items-end gap-4 min-h-[180px] overflow-hidden">
                    ...
                    <div className="relative z-50 flex shrink-0">
                        ...
                        >
                            {!isBlocked ? 
                                <>
                                    <Block fontSize="small"/> <span className="hidden sm:inline">Block Artist</span><span className="sm:hidden">Block</span>
                                </>
                             : 
                                <>
                                    <SettingsBackupRestore fontSize="small"/> <span className="hidden sm:inline">Unblock</span>
                                </>
                            }
                        </button>
                    </div>
